...
//import javafx.scene.image.Image; ///////////// importante para las imagenes
 ...
 */
	...
	public void mostrar() {
		...
		grilla.styleProperty().set("-fx-background-color: #EEC57D"); ////////////// usar en tema
...
//		herramienta.setFill(Color.web("#f4f4f4"));
		...
		herramienta.setFill(Color.web("#EEC57D")); ///////////// usar en tema
...
//			jugador1.equalsIgnoreCase(jugador2)
