...
public class Aplicacion extends Application {
	...
	private ChoiceBox<String> listaDeTemas = new ChoiceBox<String>();
...
//		grilla.styleProperty().set("-fx-background-color: #C5EFE2");
		...
		//listaDeTemas.setStyle("-fx-background-color: linear-gradient(#444444, #9CD672); -fx-text-fill: white;");
...
//		            	System.out.println(choiceBox.getValue());
		...
		/*Cargo de valores mi lista de temas*/
		//listaDeTemas.getItems().addAll("Tema 1","Tema 2","Tema 3");
		//listaDeTemas.setValue("Tema 1");
...
//		grilla.setGridLinesVisible(true);
		...
		GridPane.setHalignment(listaDeTemas, HPos.CENTER);
	...
	public void iniciar() {
		...
		CuatroEnLinea juego = new CuatroEnLinea(filas, columnas, 
												nombreJugadorRojo, nombreJugadorAmarillo,colorSeleccionadoJugador1,colorSeleccionadoJugador2,alMejorDe);
