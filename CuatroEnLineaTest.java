...
public class CuatroEnLineaTest {
	...
	public void preguntarSiHayGanadorAlComienzo(){
		...
		CuatroEnLinea c = new CuatroEnLinea(4, 4, "Juan", "Pedro");
		assertEquals(true, c.hayGanador());
	}
	...
	@Test
	public void crearUnTableroDelMaximoTamañoPermitido(){
...
//	}
	...
	public void intentarPonerMasFichasDelTamañoDelTableroYQueNoSeSalgaDeRango(){
